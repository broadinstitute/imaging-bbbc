...
1. Make sure you are up to date with the remote master (first cd into your local directory): `git checkout master` , `git fetch origin` , `git pull origin master`.
...
1. Run `git commit -m "Added new dataset BBBC<NEW-DATASET> (resolves #XX)"`
